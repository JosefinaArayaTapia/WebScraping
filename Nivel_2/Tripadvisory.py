...
class TripAdvisory(CrawlSpider):  # Cuando es Spider Vertical u Horizatonal
    ...
    start_urls = [
        'https://www.tripadvisor.cl/Hotels-g187791-Rome_Lazio-Hotels.html']
    ...
    def parse_hotel(self, response):
        ...
        item.add_xpath(
            'Descripcion', './/div[@id="ABOUT_TAB"]/div[2]/div[1]/div[7]/div[1]/div[1]/div/p/text()')
        item.add_xpath(
            'Comodidades', './/div[contains(@data-test-target, "amenity_text")]/text()')
